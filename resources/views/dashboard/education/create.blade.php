...
@section('container')
    ...
    @csrf
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control form-control-sm @error('info_rd') is-invalid @enderror"  name="info_rd" id="info_rd" placeholder="Company Name" value="{{ old('info_rd') }}" autofocus>
