...
@section('container')
    ...
    @method('put')
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control form-control-sm @error('info_rd') is-invalid @enderror"  name="info_rd" id="info_rd" placeholder="Company Name" value="{{ old('info_rd', $history->info_rd) }}" autofocus>
